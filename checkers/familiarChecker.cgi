...
import string, cgi, cgitb, crypt, hashutils
...
[ "Adorable Seal Larva", "seallarva.gif", 83],
[ "Untamed Turtle", "untamed.gif", 84],
[ "Animated Macaroni Duck", "macaroniduck.gif", 85],
[ "Pet Cheezling", "cheezblob.gif", 86],
[ "Autonomous Disco Ball", "discoball.gif", 87],
[ "Mariachi Chihuahua", "chihuahua.gif", 88], 
...
if form.has_key('familiars') or form.has_key('hash'):
   ...
   for familiarData in familiarList:
     ...
     imglink = "http://www.alliancefromhell.com/scripts/kolimages/" + familiarImage
